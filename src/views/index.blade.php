                        ...
                        <input type='hidden' id="h_Accuracy" value=""/>
                           ...
                           <main class="main">
                              <section class="test-area">
                                ...
                                <div id="result">
                                  <a style="color: #97310e"><u>View High Scores</u></a>
                                ...
                                <span class="btn btn-primary" onclick='return change_paragraph()'><span id='text_change'>Start</span> Test</span>
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
  ...
  <script>
        ...
        if (textEntered == originText) {
            ...
            if (textEntered == originTextMatch ) {
                ...
                if(key == 8 && key == 27){
                    ...
                    //console.log(incorrect_spell_count,'llll')
                    data.incorrect_word_count = incorrect_spell_count
                    //$("#origin-text").css("background-color", "#ffeeee");
    ...
    function WPM(data){
      ...
      //console.log(data.strcount,data.incorrect_word_count)
      //console.log(NWPM,Accuracy,correct_word,time,GWMP,'before')
        ...
        //console.log(NWPM,Accuracy,correct_word,time,GWMP,'after')
    ...
    function processCurrentText(){
      ...
      //console.log("inputtext",curr_input_array)
    ...
    window.addEventListener("keydown", function(e) {
     ...
     $('.input_area').hide();
         setTimeout(function() { $('.input_area').focus() }, 3000);
